...
namespace JustFajar\Belajar\PHP\MVC\Controller {
  ...
  class UserControllerTest extends TestCase
  {
    ...
    protected function setUp(): void
    {
      ...
      $this->userReposotory = new UserRepository(Database::getConnection());
      $this->userReposotory->deleteAll();
    ...
    public function testPostRegisterValidationError()
    {
      ...
      $this->expectOutputRegex("[Name]");
      $this->expectOutputRegex("[Password]");
      $this->expectOutputRegex("[Id, Name, Password can not blan]");
    }
    ...
    public function testLoginValodatonError()
    {
      $_POST['id'] = '';
      $_POST['password'] = '';
    ...
    public function testPostUpdateProfileSuccess()
    {
      ...
      $result = $this->userReposotory->findById("eko");
    ...
    public function testPostUpdatePasswordSuccess()
    {
      ...
      $result = $this->userReposotory->findById($user->id);
